...
uint256 hashGenesisBlock("0xf052eb8107b742bca6791297530e74b0604da09486011a51f1f895f347d85dbf");
...
const string strMessageMagic = "BasileusCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 4 * 60; // BasileusCoin: 0.35 days    // TIEMPO EN REAJSUTAR LA DIFICULTAD DE LA MINERIA / ES PROPORCIONAL AL NUMERO DE MONEDAS EXISTENTES
static const int64 nTargetSpacing = 30; // BasileusCoin: 10 seconds
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal BasileusCoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "BasileusCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
	...
	CBlock(hash=14dc23f54de47df79717, PoW=00000aeb1f05fbf0b2fa, ver=1, 			hashPrevBlock=00000000000000000000, hashMerkleRoot=ef7e256a2c, 			nTime=1399574511, nBits=1e0ffff0, nNonce=2086299649, vtx=1)
  	...
  	vMerkleTree: ef7e256a2c */
        ...
        // Genesis block
        const char* pszTimestamp = "primer dia de BasileusCoin";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1511036202;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2088905343;
        ...
        assert(block.hashMerkleRoot == uint256("0x1d30d55f9486ab3ea13e01a5450d086120b3e036d42b5e75af33674e8efb050e"));
